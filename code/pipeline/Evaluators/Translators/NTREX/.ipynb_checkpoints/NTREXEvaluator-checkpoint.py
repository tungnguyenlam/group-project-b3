...
class NTREXEvaluator:
    ...
    def evaluate(self, model, batch_size=8, device='cuda', verbose=False):
        ...
        model.load_model(device=torch.device('cuda'))
        ...
        metric_sacrebleu = SacreBLEUScore()                  # SacreBLEU also expects references as [[ref1, ref2], [ref1]]      
        sacre_bleu = metric_sacrebleu(predicted, bleu_formatted_refs)
        ...
        metrics_data = [
            ...
            ["SacreBLEU Score", f"{sacre_bleu.item():.4f}"], # New addition
